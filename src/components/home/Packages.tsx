...
function Packages() {
  const packages = [
    ...
    },
    {
      name: "Matura Package",
      description:
        "Preparation for the national matura exam with subject practice and simulations.",
      features: [
      ...
      <div className="app-container">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
          {packages.map((pkg) => (
            <div
              key={pkg.name}
              className={`relative flex min-h-96 flex-col rounded-xl p-5 shadow-sm ${
                pkg.featured
            ...
            >
              ...
              <div className="flex flex-1 flex-col">
                <h3
                  className={`text-lg font-bold ${pkg.featured ? "text-white" : "text-gray-900"}`}
                >
                  {pkg.name}
                </h3>
