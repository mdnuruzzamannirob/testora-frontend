      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        <div>
          ...
          <div className="mt-3 flex gap-2">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="hover:border-primary flex h-16 w-16 cursor-pointer items-center justify-center overflow-hidden rounded-md border-2 border-gray-100 bg-gray-50"
              >
        ...
        <div>
          <div className="mb-1 flex items-start justify-between gap-3">
            <p className="text-primary text-xs font-medium">{product.category}</p>
          ...
          <div className="mb-4 grid grid-cols-2 gap-3">
            <button
              ...
              className="border-primary text-primary hover:bg-primary/5 flex items-center justify-center gap-2 rounded-md border py-3 text-sm font-semibold"
            >
              <ShoppingCart className="h-4 w-4" />
              {added ? "Added!" : "Add to Cart"}
            </button>
            <button className="bg-primary hover:bg-primary/90 rounded-md py-3 text-sm font-semibold text-white duration-200">
              Buy Now
            </button>
          </div>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {product.related.map((r) => (
              ...
              >
                <div className="flex h-32 items-center justify-center bg-sky-50">
                ...
                <div className="p-3">
                  ...
                  <p className="mt-0.5 text-xs font-semibold text-slate-900">{r.name}</p>
