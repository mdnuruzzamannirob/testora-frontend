  ...
  return (
    <section className="app-container flex-1 py-10">
      ...
      <div className="mb-8 flex flex-col gap-5 rounded-2xl border border-blue-200 bg-blue-50 p-5 sm:flex-row sm:items-center sm:p-6">
        <div className="bg-primary flex h-12 w-12 items-center justify-center rounded-2xl shadow-md">
          <Smartphone className="h-6 w-6 text-white" />
        </div>
        <div className="flex-1">
          <h2 className="text-base font-bold text-blue-900">Learning Happens in the Mobile App</h2>
          <p className="text-primary mt-0.5 text-sm">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="bg-primary hover:bg-primary flex items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-semibold text-white">
            <Download className="h-4 w-4" />
            Download Mobile App
          </button>
          <button className="text-primary hover:bg-primary/5 rounded-xl border border-blue-300 px-4 py-2 text-sm font-semibold">
            Learn More
          </button>
        </div>
      </div>
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {ACTIVE_PACKAGES.map((pkg) => (
            <div key={pkg.id} className="relative rounded-2xl border border-gray-200 bg-white p-5">
              ...
              <button className="group text-primary hover:text-primary flex items-center gap-1 text-xs font-semibold">
                View Details
      ...
      <section className="from-primary to-primary2 rounded-2xl bg-linear-to-br p-8 text-center text-white shadow-lg">
        ...
        <p className="text-primary/5 mx-auto mb-6 max-w-sm text-sm">
          Explore our full range of learning packages designed to help you achieve your exam goals.
        </p>
        <Link
          href={ROUTES.PACKAGES}
          className="text-primary inline-block rounded-md bg-white px-6 py-3 text-sm font-medium hover:bg-white/90"
        >
          Browse Packages
        </Link>
      </section>
