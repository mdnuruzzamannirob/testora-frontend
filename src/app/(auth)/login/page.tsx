        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                "w-full rounded-lg border py-2.5 pl-10 pr-3.5 text-sm text-gray-900 placeholder-gray-400 transition outline-none",
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                "w-full rounded-lg border py-2.5 pl-10 pr-10 text-sm text-gray-900 placeholder-gray-400 transition outline-none",
                "focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20",
                errors.password
                  ? "border-red-400 bg-red-50 focus:border-red-400 focus:ring-red-400/20"
                  : "border-gray-200 bg-white"
